...
class OnboardingPage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Simple testimonial data (can be replaced with dynamic/API data later)
    final testimonials = [
      {
        'name': 'Dr. R. Sharma',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Title block (match design: colored first word, bold second line)
              Text(
                'Testimonials',
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    // Reviews image section (placeholder using existing asset)
                    Expanded(
                      child: Container(
